...
export default function App() {
  ...
  const [item, setItem] = useState(null);import React, { useState, useEffect } from 'react';
import './App.css';
...
export default function App() {
  ...
  const [showAlert, setShowAlert] = useState(true); // แสดงการแจ้งเตือนตั้งแต่หน้า login
